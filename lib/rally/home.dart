...
import 'package:gallery/rally/tabs/accounts.dart';
import 'package:gallery/rally/tabs/budgets.dart';
import 'package:gallery/rally/tabs/overview.dart';
import 'package:gallery/rally/tabs/settings.dart';
...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin, RestorationMixin {
  ...
  List<Widget> _buildTabs(
      {required BuildContext context, ThemeData? theme, bool isVertical = false}) {
    return [
      _RallyTab(
        theme: theme!,
