...
class _AddWalletFormState extends State<AddWalletForm> {
  ...
  void _addInfo({required String phrase, required String privateKey, required String publicKey, required String address, required Fork fork}) async {
