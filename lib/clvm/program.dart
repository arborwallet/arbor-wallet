...
import 'package:arbor/clvm/instructions.dart';
import 'package:arbor/clvm/ir.dart';
import 'package:arbor/clvm/keywords.dart';
import 'package:arbor/clvm/parser.dart';
import 'package:arbor/clvm/printable.dart';
        ...
        try {
          ...
          for (var i = 0; i < string.length; i++) {
            if (!printable.contains(string[i])) {
              return '0x' + const HexEncoder().convert(atom);
            }
          }
