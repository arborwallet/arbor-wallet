...
class GalleryLocalizationsFa extends GalleryLocalizations {
  ...
  @override
  String get demoSelectionControlsSwitchDescription => 'کلیدهای روشن/خاموش وضعیت یک گزینه تنظیمات را تغییر می‌دهد گزینه‌ای که کلید کنترل می‌کند و وضعیتی که در آن است باید از‌طریق برچسب به‌خط مربوطه معلوم شود.';
