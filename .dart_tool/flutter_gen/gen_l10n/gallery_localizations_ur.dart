...
class GalleryLocalizationsUr extends GalleryLocalizations {
  ...
  @override
  String get demoSnackbarsDescription => 'اسنیک بارز صارفین کو اس کارروائی سے متعلق بتاتا ہیں جو ایک ایپ نے انجام دیا ہے یا انجام دے گا۔ وہ اسکرین کے نچلے حصے کی طرف عارضی طور پر ظاہر ہوتے ہیں۔ انہیں صارف کے تجربے میں مداخلت نہیں کرنی چاہیے، اور انہیں ظاہر کرنے کے ليے صارف کے ان پٹ کی ضرورت نہیں ہے۔';
  ...
  @override
  String get demoSelectionControlsSwitchDescription => 'آن/آف سوئچز ترتیبات کے واحد اختیار کو ٹوگل کرتا ہے۔ اختیار جسے سوئچ کنٹرول کرتا ہے، اور اس میں موجود حالت متعلقہ ان لائن لیبل سے واضح کیا جانا چاہیے۔';
