...
class GalleryLocalizationsPt extends GalleryLocalizations {
  ...
  @override
  String get demoDataTableDescription => 'As tabelas de dados apresentam informações em grades de linhas e colunas. As informações são organizadas de modo a facilitar a leitura. Dessa forma, os usuários podem procurar por padrões e insights.';
  ...
  @override
  String get demoSharedYAxisDemoInstructions => 'Classificar por \"Tocados recentemente\"';
  ...
  @override
  String get demoSnackbarsDescription => 'Os snackbars informam os usuários sobre processos que o app realizou ou realizará. Eles aparecem temporariamente, na parte inferior da tela. Eles não interrompem a experiência do usuário e não precisam de nenhuma entrada para desaparecer.';
  ...
  @override
  String get demoSelectionControlsSwitchDescription => 'A chave ativar/desativar alterna o estado de uma única opção de configuração. A opção controlada pelo botão, assim como o estado em que ela está, precisam ficar claros na etiqueta in-line correspondente.';
...
class GalleryLocalizationsPtPt extends GalleryLocalizationsPt {
  ...
  @override
  String get demoDataTableDescription => 'As tabelas de dados apresentam informações num formato de grelha de linhas e colunas. Organizam informações de uma forma fácil analisar para que os utilizadores possam procurar padrões e estatísticas.';
