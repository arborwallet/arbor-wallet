...
class GalleryLocalizationsDe extends GalleryLocalizations {
  ...
  @override
  String get demoDataTableDescription => 'Bei Datentabellen werden Informationen in einem rasterähnlichen Format aus Zeilen und Spalten angezeigt. Darin werden Daten so angeordnet, dass sie leicht zu erfassen sind und die Nutzer nach Mustern und anderen Auffälligkeiten suchen können.';
  ...
  @override
  String get demoSelectionControlsSwitchDescription => 'Mit Schiebereglern können Nutzer den Status einzelner Einstellungen ändern. Anhand des verwendeten Inline-Labels sollte man erkennen können, um welche Einstellung es sich handelt und wie der aktuelle Status ist.';
...
class GalleryLocalizationsDeCh extends GalleryLocalizationsDe {
  ...
  @override
  String get demoBottomAppBarDescription => 'App-Leisten am unteren Rand bieten Zugriff auf eine Navigationsleiste und bis zu vier Aktionen, einschliesslich der unverankerten Aktionsschaltfläche.';
  ...
  @override
  String get demoCupertinoSegmentedControlDescription => 'Wird verwendet, um aus einer Reihe von Optionen zu wählen, die sich gegenseitig ausschliessen. Wenn eine Option in der segmentierten Steuerung ausgewählt ist, wird dadurch die Auswahl für die anderen Optionen aufgehoben.';
  ...
  @override
  String get demoCupertinoTabBarDescription => 'Eine untere Tab-Leiste zur Navigation im Stil von iOS. Darauf werden mehrere Tabs angezeigt, wobei jeweils ein Tab aktiv ist – standardmässig der erste.';
  ...
  @override
  String get demoListsDescription => 'Eine Zeile in der Liste hat eine feste Höhe und enthält normalerweise Text und ein anführendes bzw. abschliessendes Symbol.';
